<%@ page language="java" contentType="text/html; charset= UTF-8"
    pageEncoding="UTF-8"%>
<jsp:useBean id="beantest" class="test.BeanJoin" scope="page"/>
...
<table width="50%" height="80" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#9999FF">
    ...
    <tr>
        <td bgcolor="pink" align="center">
            <div style="font-weight: bold;">학번:
            </div></td>
        <td>&nbsp<input type="text" name="my_studnetid" id="my_studnetid" size="12" maxlength="12">&nbsp</td>
    </tr>
    <tr>
        <td bgcolor="pink" align="center"><div style="font-weight: bold;">이름:</div></td>
        <td>&nbsp<input type="password" name="my_name" id="my_name" size="12" maxlength="12">&nbsp</td>
    </tr>
    <tr>
